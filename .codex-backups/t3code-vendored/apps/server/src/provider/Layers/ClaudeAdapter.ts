...
import { createSpectrumBrowserThreadEnv } from "../../spectrumBrowserThreadEnv.ts";
...
interface ClaudeSessionContext {
  ...
  readonly browserThreadEnvCleanup: () => void;
...
const makeClaudeAdapter = Effect.fn("makeClaudeAdapter")(function* (
  ...
  const stopSessionInternal = Effect.fn("stopSessionInternal")(function* (
    ...
    yield* Effect.sync(context.browserThreadEnvCleanup);
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const browserThreadEnv = createSpectrumBrowserThreadEnv(input.threadId, process.env);
      ...
      }).pipe(Effect.tapError(() => Effect.sync(browserThreadEnv.cleanup)));
      ...
      const context: ClaudeSessionContext = {
        ...
        promptQueue,
        query: queryRuntime,
        browserThreadEnvCleanup: browserThreadEnv.cleanup,
