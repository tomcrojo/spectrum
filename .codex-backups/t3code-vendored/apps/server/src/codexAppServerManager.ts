...
import { createSpectrumBrowserThreadEnv } from "./spectrumBrowserThreadEnv";
...
export class CodexAppServerManager extends EventEmitter<CodexAppServerManagerEvents> {
  ...
  async startSession(input: CodexAppServerStartSessionInput): Promise<ProviderSession> {
    ...
    let browserThreadEnvCleanup: (() => void) | undefined;
    ...
    try {
      ...
      const browserThreadEnv = createSpectrumBrowserThreadEnv(threadId, process.env);
      browserThreadEnvCleanup = browserThreadEnv.cleanup;
      const child = spawn(codexBinaryPath, ["app-server"], {
        cwd: resolvedCwd,
        env: {
          ...browserThreadEnv.env,
  ...
  stopSession(threadId: ThreadId): void {
    ...
    context.browserThreadEnvCleanup();
