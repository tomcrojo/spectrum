...
import { EffortCycleButton, TraitsMenuContent, TraitsPicker } from "./TraitsPicker";
...
const composerProviderRegistry: Record<ProviderKind, ProviderRegistryEntry> = {
  codex: {
    ...
    renderEffortButton: ({ threadId, model, models, modelOptions, prompt, onPromptChange }) => (
      <EffortCycleButton
        provider="codex"
        models={models}
        threadId={threadId}
...
export function renderProviderTraitsPicker(input: {
  ...
  return composerProviderRegistry[input.provider].renderTraitsPicker({
    ...
    showEffort: input.showEffort,
    triggerIcon: input.triggerIcon,
  });
}

export function renderProviderEffortButton(input: {
  provider: ProviderKind;
  threadId: ThreadId;
  model: string;
  models: ReadonlyArray<ServerProviderModel>;
  ...
  return composerProviderRegistry[input.provider].renderEffortButton({
    threadId: input.threadId,
    model: input.model,
    models: input.models,
    modelOptions: input.modelOptions,
